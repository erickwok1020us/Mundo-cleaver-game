class MundoKnifeGame3D {
    ...
    createPlayer3D(player) {
        const geometry = new THREE.CylinderGeometry(this.characterSize, this.characterSize, this.characterSize * 2, 6);
        ...
        const headGeometry = new THREE.SphereGeometry(this.characterSize * 0.6, 6, 4);
        const headMaterial = new THREE.MeshLambertMaterial({ color: this.lightenColor(player.color, 0.3) });
        const head = new THREE.Mesh(headGeometry, headMaterial);
        head.position.set(0, this.characterSize * 1.5, 0);
    ...
    createHealthDisplay(player) {
        ...
        sprite.position.set(0, this.characterSize * 3.2, 0);
